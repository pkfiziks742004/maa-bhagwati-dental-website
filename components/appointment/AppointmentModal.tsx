      ...
      {isOpen && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
          ...
          <motion.div
            ...
            className="relative w-full max-w-[550px] bg-white rounded-2xl shadow-2xl overflow-hidden z-10"
          >
            {/* Close Button */}
            <button
              onClick={closeModal}
              disabled={isLoading}
              className="absolute top-4 right-4 p-2 bg-gray-50 hover:bg-gray-100 text-gray-500 hover:text-gray-800 rounded-full transition-colors z-20 border border-gray-100 disabled:opacity-50"
            >
              <X size={18} />
            </button>
            ...
            {isSubmitted ? (
              <div className="p-10 text-center flex flex-col items-center justify-center min-h-[500px]">
                ...
                <div className="bg-gray-50 border border-gray-200 px-6 py-3 rounded-lg inline-block">
              ...
              <div className="p-6 md:p-8">
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-extrabold text-[#1b365d] mb-0.5 tracking-tight">Book Appointment</h3>
